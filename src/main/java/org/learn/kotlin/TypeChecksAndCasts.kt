...
fun main(args: Array<String>) {
    ...
    val y: String = obj as String //when obj is null this code throws an exception.but we can use safe nullable cast operator

    val t: String? = obj as? String // safe nullable cast operator
}

//In many cases, one does not need to use explicit cast operators in Kotlin, because the compiler tracks the "is-checks"
